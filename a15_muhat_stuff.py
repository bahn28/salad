...
# 그룹별( m - f)
    muhat_m = hgt_m.mean()
    muhat_f = hgt_f.mean()
    se_muhat_m = hgt_m.std()/ np.sqrt( n_m )
    se_muhat_f = hgt_f.std() / np.sqrt( n_f )
...
# 그룹별 ( m - f )
    ...
    print( "    muhat,    se of muhat,     confidence interval ")
    print( muhat_m, se_muhat_m, ci_lm, ci_rm ) 

    ci_rf = muhat_f + zcv_r * se_muhat_f 
    ci_lf = muhat_f - zcv_r * se_muhat_f 
    print( "    muhat,    se of muhat,     confidence interval ")
    print( muhat_f, se_muhat_f, ci_lf, ci_rf ) 
